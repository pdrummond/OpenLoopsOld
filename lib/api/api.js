OpenLoops = {
	...
	createAction: function(actionType, title, subject) {
		OpenLoops.createItem(actionType, title, '', subject);
	},

	createMessage: function(text, subject) {
		OpenLoops.createItem('message', '', text, subject);
	},

	createItem: function(type, title, text, subject) {
		type = type || 'message';
