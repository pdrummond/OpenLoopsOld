OpenLoops = {
	...
	createAction: function(actionType, title, subjectItemId) {
		OpenLoops.createItem(actionType, title, '', subjectItemId);
	},
	...
	createItem: function(type, title, text, subjectItemId) {
		subjectItemId = subjectItemId || '';
		type = type || 'task';
